# Script with extraction of 100K data entires for final dataset
...
source_folder = '/Volumes/Backup'  # Absolute path to the source folder
destination_folder = '/final_dataset/1_extracted_data'  # Updated destination folder name
...
def main():
    ...
    # FigureQA
    results['FigureQA'] = {}
    results['FigureQA']['train'] = copy_figureqa_files(source_path, destination_path, 'train', 21701)
    ...
    # PlotQA
    results['PlotQA'] = {}
    results['PlotQA']['train'] = copy_plotqa_files(source_path, destination_path, 'train', 30000)
    results['PlotQA']['test'] = copy_plotqa_files(source_path, destination_path, 'test', 7500)
    results['PlotQA']['val'] = copy_plotqa_files(source_path, destination_path, 'val', 8080)
